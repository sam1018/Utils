...
BOOST_AUTO_TEST_CASE(test_intros_ptree_tags_read_intros)
{
	//item_has_intros
...
BOOST_AUTO_TEST_CASE(test_intros_ptree_tags_write_intros)
{
	//item_has_intros
...
BOOST_AUTO_TEST_CASE(test_intros_ptree_c_array)
{
	ptree tree;
	test_c_array ob{};
...
BOOST_AUTO_TEST_CASE(test_intros_ptree_no_intros)
{
	test_no_intros ob;
	ptree tree;
	// following won't compile
...
BOOST_AUTO_TEST_CASE(test_intros_ptree_nested_no_intros)
{
...
BOOST_AUTO_TEST_CASE(test_intros_ptree_unsupported_type)
{
...
BOOST_AUTO_TEST_CASE(test_intros_type_unsupported_no_def_ctor)
{
...
BOOST_AUTO_TEST_CASE(test_intros_ptree_general)
{
	string s = R"(
...
BOOST_AUTO_TEST_CASE(test_intros_ptree_dif_names)
{
	string s = R"(
...
BOOST_AUTO_TEST_CASE(test_intros_ptree_multiple_items_diff_scope)
{
	string s = R"(
{"test_multiple_items_diff_scope":{"x":"10", "temp_scope":{"s":"hello", "d":"123.456"}, "b":"true"}}
	...
	//write_json(cout, tree);

	stringstream ss(s);
	check(ss, val);
}

BOOST_AUTO_TEST_CASE(test_intros_struct_containers)
{
	string s = R"(
{"test_containers":{"x":"10", "vs":"string1", "sd":"-40", "vs":"string2", "vs":"string3", "sd":"-20", "sd":"100"}}
)";
	test_containers val;
	val.x = 10;
...
BOOST_AUTO_TEST_CASE(test_intros_struct_containers_diff_scope)
{
	string s = R"(
...
BOOST_AUTO_TEST_CASE(test_intros_struct_attributes)
{
	string s = R"(
